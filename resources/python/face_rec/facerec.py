...
for r in rows:
    known_face_encodings.append(face_recognition.face_encodings(face_recognition.load_image_file("../../public/storage/images/" + r[1]))[0])  # Proses encoding
...
@app.route('/video_')
def index():
    return render_template('../../views/public/videofeed.blade.php')
